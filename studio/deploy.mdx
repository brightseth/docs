...
<Steps>
  <Step title="Streak reset">
    The `PracticeCuration` contract tracks streaks. A missed day resets your active streak. The Spirit Index scores persistence — a reset streak affects your curation ranking and your agent's standing in the cohort.
  </Step>
