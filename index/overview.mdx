...
description: "Spirit Index tracks 170+ AI agents across 9 scored dimensions — measuring real agency, continuity, and cultural impact, not hype."
---
...
Once installed, you can run commands like `spirit_index_search`, `spirit_index_agent`, `spirit_index_compare`, and `spirit_index_rubric` directly in your AI coding environment.
