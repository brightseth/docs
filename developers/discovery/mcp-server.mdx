---
title: "Spirit Index MCP Server and Claude Integration"
...
| `spirit_index_rubric` | Retrieve the evaluation framework and dimension definitions |
...
Retrieve the full evaluation rubric — the 7-dimension (or 9-dimension) framework that Spirit curators use to score agents. Use this when you want to understand what Spirit Index measures and how each dimension is defined.
