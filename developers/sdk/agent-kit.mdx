...
description: "Sentinel extraction, payload drift validation, and session-keyed ring buffers — the shared primitives extracted from the SOLIENNE encounter pipeline for any Spirit agent."
---
...
The smoke suite covers all three primitives end-to-end across 15 cases. It has zero dependencies and runs fast enough for a pre-push hook.
