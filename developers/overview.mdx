...
<CardGroup cols={2}>
  <Card title="spirit-protocol-sdk" icon="cube" href="/developers/sdk">
  ...
  <Card title="@spirit/agentic-crm" icon="address-book" href="/developers/sdk/agent-kit">
    TypeScript CRM layer for agents managing ongoing relationships with
